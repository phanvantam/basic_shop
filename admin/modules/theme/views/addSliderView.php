                    ...
                    <div class="section-detail">
                        <form method="POST"  enctype = "multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="caption" maxlength="200" id="caption"><?php echo set_value('caption') ; ?></textarea>
                            ...
                            <div class="form-group">
                                <button type="submit" name="add_slider" id="btn-submit">Xác nhận thêm</button>
                            </div>
                        </form>
                    </div>
                </div>
