    ...
    <div id="main-content-wp" class="add-cat-page menu-page">
        <div class="section" id="title-page">
            <div class="clearfix">
                ...
                <h3 id="index" class="fl-left">Chỉnh sửa Menu</h3>
            </div>
        </div>
                    ...
                    <div id="list-menu" class="fl-left">
                        <form  method="POST" action="">
                            ...
                            <div class="form-group clearfix">
                                ...
                                <div class="content-hidden">
                                    <?php
                                    $cat_product = db_fetch_array('SELECT * FROM tbl_category WHERE type = 2 ') ;
                            ...
                            <div class="form-group clearfix">
                                ...
                                <div class="content-hidden">
                                    <?php
                                    $cat_post = db_fetch_array('SELECT * FROM tbl_category WHERE type = 1 ') ;
                                    if(!empty($cat_post)){
                            ...
                            <div class="form-group">
                                ...
                                <input d type="radio" id="type-home"  <?php if($type==4){echo 'checked'; $page_active = $active ;}else $page_active = 0 ; ?> value="4" name="type">
                            </div>
                            <div class="form-group clearfix">
                                ...
                                <?php
                                    ...
                                    echo show_select($list_location,$location_active,array('name'=>'location','attr'=>'disabled'),'') ;
                                ?>
                            ...
                            <div class="form-group clearfix" style="display:<?php echo $hide_footer ; ?>" id="select-parent-footer">
                                ...
                                echo show_select($list_menu, set_value('parent_footer'),array('name'=>'parent_footer')) ;
                                ?>
                            ...
                            <div class="form-group clearfix" style="display:<?php echo $hide_sidebar ; ?>" id="select-parent-sidebar">
                                ...
                                if($list_menu){
                                    $list_menu = multi_data_add_level($list_menu,array('name_id'=>'menu_id','parent_id'=>0,'level'=>0));
                                    $list_menu = convert_level_to_str($list_menu,'--','title') ;
                                    $list_menu= convert_show_select($list_menu, array('k'=>'menu_id','v'=>'title')) ;
                                }
                                $list_menu[0] = 'Lựa chọn menu cha ' ;
                                echo show_select($list_menu, set_value('parent_sidebar'),array('name'=>'parent_sidebar')) ;
                                ?>
                             ...
                             <div class="form-group clearfix" style="display:<?php echo $hide_respon ; ?>" id="select-parent-respon">
                                ...
                                if($list_menu){
                                    $list_menu = multi_data_add_level($list_menu,array('name_id'=>'menu_id','parent_id'=>0,'level'=>1));
                                    $list_menu = convert_level_to_str($list_menu,'---','title') ;
                                    $list_menu= convert_show_select($list_menu, array('k'=>'menu_id','v'=>'title')) ;
                                }
                                $list_menu[0] = 'Lựa chọn menu cha ' ;
                                echo show_select($list_menu, set_value('parent_respon'),array('name'=>'parent_respon')) ;
                                ?>
                            ...
                            <div class="form-group">
                                <button type="submit" name="edit_menu" id="btn-save-list">Lưu thay đổi</button>
                            </div>
                        </form>
                        <p>Sửa lần cuối lúc: <?php echo format_date($info_menu['modify_at']) ;?></p>
                        <p>Người sửa: <?php echo get_info_user_by_id($info_menu['modify_by'],'fullname') ;?></p>
                    </div>
