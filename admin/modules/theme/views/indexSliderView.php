<?php get_header() ; ?>
    <div id="main-content-wp" class="list-post-page">
        <div class="section" id="title-page">
            <div class="clearfix">
                <a href="?mod=theme&controller=slider&action=add" title="" id="add-new" class="fl-left">Thêm mới</a>
                    ...
                    <div class="section-detail">
                        ...
                        <div class="table-responsive">
                            <table class="table list-table-wp">
                                ...
                                <tbody>
                                <?php if(!empty($list_slider['data'])){
                                    $stt = $list_slider['stt'] ;
                                    foreach ($list_slider['data'] as $item) {
                                        $stt++ ;
                                ?>
                                        <tr>
                                            <td><input type="checkbox" name="id[]" value="<?php echo $item['slider_id'] ; ?>" class="checkItem"></td>
