<?php get_header(); ?>
    <div id="main-content-wp" class="info-account-page">
        <div class="section" id="title-page">
            <div class="clearfix">
                <a href="?mod=sytem&controller=support&action=index" title="" id="add-new" class="fl-left">Danh sách hỗ trợ</a>
                <h3 id="index" class="fl-left">Thêm thông tin hỗ trợ </h3>
            </div>
        </div>
                    ...
                    <div class="section-detail">
                        <form method="POST"  enctype = "multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" maxlength="100" name="title" maxlength="100" value="<?php echo set_value('title') ; ?>" id="title">
                            ...
                            <div class="form-group">
                                <button type="submit" name="add" id="btn-submit">Xác nhận thêm</button>
                            </div>
