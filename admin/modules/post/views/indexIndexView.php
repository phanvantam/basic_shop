<?php get_header() ; ?>
    <div id="main-content-wp" class="list-post-page">
        <div class="section" id="title-page">
            <div class="clearfix">
                <a href="?mod=post&controller=index&action=add" title="" id="add-new" class="fl-left">Thêm bài viết</a>
                        ...
                        <div class="table-responsive">
                            <table class="table list-table-wp">
                                ...
                                <?php if(!empty($list_post['data'])){
                                    $stt = $list_post['stt'] ;
                                    foreach ($list_post['data'] as $item) {
                                        $stt++ ;
                                        ?>
                                        <tr>
                                            <td><input type="checkbox" name="id[]" value="<?php echo $item['post_id'] ; ?>" class="checkItem"></td>
                                            ...
                                            <td class="clearfix">
                                                <div class="tb-title fl-left">
                                                    <a href="<?php echo base_url_frontend().$item['slug'].'-'.$item['post_id'].'html' ; ?>" title=""><?php echo $item['title']; ?></a>
                                                </div>
                                            </td>
                                            <td>
