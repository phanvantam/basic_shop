...
<div id="main-content-wp" class="list-cat-page">
    <div class="section" id="title-page">
        <div class="clearfix">
            <a href="?mod=product&controller=cat&action=add" title="" id="add-new" class="fl-left">Thêm danh mục</a>
                    ...
                    <div class="table-responsive">
                        <table class="table list-table-wp">
                            ...
                            <?php if(!empty($list_cat)){
                                $url_actions = '?mod=product&controller=cat&action=actions' ;
                                $stt = 0 ;
                                    ...
                                    <tr>
                                        ...
                                        <td class="clearfix">
                                            <div class="tb-title fl-left">
                                                <span style="color: #0183f3"><?php echo $item['title']; ?></span>
                                            </div>
                                        </td>
                                        <td>
