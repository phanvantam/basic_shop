                ...
                <div class="section-detail">
                    <form method="POST">
                        <div class="form-group">
                            <input type="hidden" id="product_id" value="<?php echo set_value('product_id') ; ?>">
                        ...
                        <div class="form-group">
                            <button type="submit" name="edit_product" id="btn-submit">Lưu thay đổi</button>
                        </div>
                    </form>
                    <p>Sửa lần cuối lúc: <?php echo format_date($info_product['modify_at']) ;?></p>
                    <p>Người sửa: <?php echo get_info_user_by_id($info_product['modify_by'],'fullname') ;?></p>
                </div>
            </div>
        </div>
    </div>
